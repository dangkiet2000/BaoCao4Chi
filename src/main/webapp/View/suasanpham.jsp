                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="http://localhost:8080/WebNhom_war/EditProduct" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="${product.img1}" name="img" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="${product.sup}" type="text" name="sup" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="${product.priceSale}" name="priceSale" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="${product.active}" name="active" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    margin-left: 330px;" type="submit" class="btn btn-primary pull-right">Edit</button>
