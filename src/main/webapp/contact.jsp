...
<head>
    ...
    <title>Liên lạc - Luxury Watches</title>		<link href="css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
            ...
            <div class="col-md-6 top-header-left">
                <div class="drop">
                    ...
                    <div class="box2">
                        <a>ĐĂNG NHẬP</a>
                        <ul id="kkk">
                            <li class="menu-tiki1"><a>Đăng nhập</a></li>
                            <li class="menu-tiki2"><a>Tạo tài khoản</a></li>
...
<!--start-logo-->
<div class="logo">
    <a href="index2.html"><h1>Luxury Watches</h1></a>
</div>
<!--start-logo-->
<!--bottom-header-->
    ...
    <div class="container">
        <div class="header">
            <div class="col-md-9 header-left">
                <div class="top-nav">
                    <ul class="memenu skyblue"><li class="active"><a href="index2.html">Trang Chủ</a></li>
...
<div class="contact">
    <div class="container">
        <div class="contact-top heading">
            <h2 style="font-family: Arial, Helvetica, sans-serif;">Liên Hệ</h2>
        </div>
        <div class="contact-text">
            <div class="col-md-3 contact-left">
                <div class="address">
                    <h5>Địa Chỉ</h5>
                    <p>190D Trần Quang Khải,
                        <span>P.Tân Định,</span>
                        Q.1 – TPHCM.</p>
                    <a href="https://www.google.com/maps/@9.779349,105.6189045,11z?hl=vi-VN" style="color: orange"> GoogleMap</a>
                </div>
                <div class="address">
                    <h5>Hotline</h5>
                    <p>Điện Thoại:0372272829,
                        <span>Di Động:1900909192</span>
