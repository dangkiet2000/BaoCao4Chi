                            ...
                            <div class="card-body">
                                <form >
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input value="${danhmuc.id}" name="iddm" readonly type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input value="${danhmuc.name}"  name="slug" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input value="${danhmuc.active}" name="slug"  type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <button style="margin-right:350px;" type="submit" class="btn btn-primary pull-right">Sửa</button>
