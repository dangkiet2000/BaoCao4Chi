                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="http://localhost:8080/WebNhom_war/EditNhaCungCap"  method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input name="id" value="${ncc.id}" type="text" readonly class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input name="name" value="${ncc.tenNCC}" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input name="address" value="${ncc.diachi}" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input name="phone" value="${ncc.dienthoai}" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input name="email" value="${ncc.email}" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>

                                    <button style="margin-right:350px;" type="submit" class="btn btn-primary pull-right">Edit</button>
